...
export const statusText:Record<AssetStatus,string>={draft:'草稿',parsing:'解析中',compiled:'已编译',reviewing:'审核中',approved:'已通过',published:'已发布',rejected:'已驳回',deprecated:'已废止',archived:'已归档'};
